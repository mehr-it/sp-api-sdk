<?php
	...
	final class SellingPartnerSDK
	{
		...
		private ExternalFulfillmentSDK $externalFulfillmentSDK;
		...
		public function __construct(
			...
			UploadsSDK                 $uploads,
			VendorSDK                  $vendorSDK,
			ExternalFulfillmentSDK     $externalFulfillmentSDK
		) {
			$this->oAuth                   = $oAuth;
			$this->aPlus                   = $aPlus;
			...
			$this->externalFulfillmentSDK  = $externalFulfillmentSDK;
		}
		...
		public static function create(
			...
			return new self(
				...
				ExternalFulfillmentSDK::create($httpClient, $requestFactory, $streamFactory, $configuration, $logger)
			);
		}
		...
		public function externalFulfillment(): ExternalFulfillmentSDK {
			return $this->externalFulfillmentSDK;
		}
	}
