...
namespace MehrIt\AmazonSellingPartner\Api\SmallAndLightApi;
...
final class FBASmallAndLightSDK
{
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\FBASmallAndLight\SmallAndLightFeePreviewRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\FBASmallAndLight\SmallAndLightFeePreviewRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
