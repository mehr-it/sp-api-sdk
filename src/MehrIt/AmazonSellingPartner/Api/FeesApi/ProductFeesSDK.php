...
namespace MehrIt\AmazonSellingPartner\Api\FeesApi;
...
final class ProductFeesSDK
{
     ...
     * @param \MehrIt\AmazonSellingPartner\Model\ProductFees\GetMyFeesEstimateRequest $body body (required)
     *
     ...
     * @param string $region
     * @param string $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\ProductFees\GetMyFeesEstimateRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
