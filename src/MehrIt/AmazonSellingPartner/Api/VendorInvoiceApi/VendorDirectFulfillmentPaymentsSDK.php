...
namespace MehrIt\AmazonSellingPartner\Api\VendorInvoiceApi;
...
final class VendorDirectFulfillmentPaymentsSDK
{
     ...
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentPayments\SubmitInvoiceRequest $body body (required)
     *
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentPayments\SubmitInvoiceRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
