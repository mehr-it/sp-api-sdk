...
namespace MehrIt\AmazonSellingPartner\Api\SalesApi;
...
final class SalesSDK
{
     ...
     * @return \MehrIt\AmazonSellingPartner\Model\Sales\GetOrderMetricsResponse
     */
    public function getOrderMetrics(AccessToken $accessToken, string $region, $marketplace_ids, $interval, $granularity, $granularity_time_zone = null, $buyer_type = 'All', $fulfillment_network = null, $first_day_of_week = 'Monday', $asin = null, $sku = null): \MehrIt\AmazonSellingPartner\Model\Sales\GetOrderMetricsResponse
    {
