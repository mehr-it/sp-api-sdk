...
namespace MehrIt\AmazonSellingPartner\Api\FbaOutboundApi;
...
final class FulfillmentOutboundSDK
{
    ...
    public function cancelFulfillmentOrder(AccessToken $accessToken, string $region, $seller_fulfillment_order_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\CancelFulfillmentOrderResponse::class,
            []
        );
    }
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\CreateFulfillmentOrderRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
    ...
    public function createFulfillmentOrder(AccessToken $accessToken, string $region, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\CreateFulfillmentOrderResponse::class,
            []
        );
    }
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\CreateFulfillmentOrderRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
     ...
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\CreateFulfillmentReturnRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
    ...
    public function createFulfillmentReturn(AccessToken $accessToken, string $region, $seller_fulfillment_order_id, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\CreateFulfillmentReturnResponse::class,
            []
        );
    }
     ...
     * @param string $region
     * @param string $seller_fulfillment_order_id An identifier assigned by the seller to the fulfillment order at the time it was created. The seller uses their own records to find the correct SellerFulfillmentOrderId value based on the buyer&#39;s request to return items. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\CreateFulfillmentReturnRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
    ...
    public function getFeatureInventory(AccessToken $accessToken, string $region, $marketplace_id, $feature_name, $next_token = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\GetFeatureInventoryResponse::class,
            []
        );
    }
    ...
    public function getFeatureSKU(AccessToken $accessToken, string $region, $marketplace_id, $feature_name, $seller_sku)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\GetFeatureSkuResponse::class,
            []
        );
    }
    ...
    public function getFeatures(AccessToken $accessToken, string $region, $marketplace_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\GetFeaturesResponse::class,
            []
        );
    }
    ...
    public function getFulfillmentOrder(AccessToken $accessToken, string $region, $seller_fulfillment_order_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\GetFulfillmentOrderResponse::class,
            []
        );
    }
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\GetFulfillmentPreviewRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
    ...
    public function getFulfillmentPreview(AccessToken $accessToken, string $region, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\GetFulfillmentPreviewResponse::class,
            []
        );
    }
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\GetFulfillmentPreviewRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
    ...
    public function getPackageTrackingDetails(AccessToken $accessToken, string $region, $package_number)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\GetPackageTrackingDetailsResponse::class,
            []
        );
    }
    ...
    public function listAllFulfillmentOrders(AccessToken $accessToken, string $region, $query_start_date = null, $next_token = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\ListAllFulfillmentOrdersResponse::class,
            []
        );
    }
    ...
    public function listReturnReasonCodes(AccessToken $accessToken, string $region, $seller_sku, $language, $marketplace_id = null, $seller_fulfillment_order_id = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\ListReturnReasonCodesResponse::class,
            []
        );
    }
     ...
     * @param string $region
     * @param string $seller_fulfillment_order_id The identifier assigned to the item by the seller when the fulfillment order was created. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\UpdateFulfillmentOrderRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
    ...
    public function updateFulfillmentOrder(AccessToken $accessToken, string $region, $seller_fulfillment_order_id, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\UpdateFulfillmentOrderResponse::class,
            []
        );
    }
     ...
     * @param string $region
     * @param string $seller_fulfillment_order_id The identifier assigned to the item by the seller when the fulfillment order was created. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentOutbound\UpdateFulfillmentOrderRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
