...
final class FulfillmentInboundSDK
{
    ...
    public function confirmPreorder(AccessToken $accessToken, string $region, $shipment_id, $need_by_date, $marketplace_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\ConfirmPreorderResponse::class,
            []
        );
    }
    ...
    public function confirmPreorderRequest(AccessToken $accessToken, string $region, $shipment_id, $need_by_date, $marketplace_id) : RequestInterface
    {
        ...
        // query params
        if ($need_by_date instanceof \DateTimeInterface) {
    ...
    public function confirmTransport(AccessToken $accessToken, string $region, $shipment_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\ConfirmTransportResponse::class,
            []
        );
    }
     ...
     * @param string $region
     * @param string $shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\InboundShipmentRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
    ...
    public function createInboundShipment(AccessToken $accessToken, string $region, $shipment_id, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\InboundShipmentResponse::class,
            []
        );
    }
     ...
     * @param string $region
     * @param string $shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\InboundShipmentRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\CreateInboundShipmentPlanRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
    ...
    public function createInboundShipmentPlan(AccessToken $accessToken, string $region, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\CreateInboundShipmentPlanResponse::class,
            []
        );
    }
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\CreateInboundShipmentPlanRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
    ...
    public function estimateTransport(AccessToken $accessToken, string $region, $shipment_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\EstimateTransportResponse::class,
            []
        );
    }
    ...
    public function getBillOfLading(AccessToken $accessToken, string $region, $shipment_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\GetBillOfLadingResponse::class,
            []
        );
    }
    ...
    public function getInboundGuidance(AccessToken $accessToken, string $region, $marketplace_id, $seller_sku_list = null, $asin_list = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\GetInboundGuidanceResponse::class,
            []
        );
    }
    ...
    public function getLabels(AccessToken $accessToken, string $region, $shipment_id, $page_type, $label_type, $number_of_packages = null, $package_labels_to_print = null, $number_of_pallets = null, $page_size = null, $page_start_index = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\GetLabelsResponse::class,
            []
        );
    }
    ...
    public function getPreorderInfo(AccessToken $accessToken, string $region, $shipment_id, $marketplace_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\GetPreorderInfoResponse::class,
            []
        );
    }
    ...
    public function getPrepInstructions(AccessToken $accessToken, string $region, $ship_to_country_code, $seller_sku_list = null, $asin_list = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\GetPrepInstructionsResponse::class,
            []
        );
    }
    ...
    public function getShipmentItems(AccessToken $accessToken, string $region, $query_type, $marketplace_id, $last_updated_after = null, $last_updated_before = null, $next_token = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\GetShipmentItemsResponse::class,
            []
        );
    }
    ...
    public function getShipments(AccessToken $accessToken, string $region, $query_type, $marketplace_id, $shipment_status_list = null, $shipment_id_list = null, $last_updated_after = null, $last_updated_before = null, $next_token = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\GetShipmentsResponse::class,
            []
        );
    }
    ...
    public function getTransportDetails(AccessToken $accessToken, string $region, $shipment_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\GetTransportDetailsResponse::class,
            []
        );
    }
     ...
     * @param string $region
     * @param string $shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\PutTransportDetailsRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
    ...
    public function putTransportDetails(AccessToken $accessToken, string $region, $shipment_id, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\PutTransportDetailsResponse::class,
            []
        );
    }
     ...
     * @param string $region
     * @param string $shipment_id A shipment identifier originally returned by the createInboundShipmentPlan operation. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\PutTransportDetailsRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
    ...
    public function voidTransport(AccessToken $accessToken, string $region, $shipment_id)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\FulfillmentInbound\VoidTransportResponse::class,
            []
        );
    }
