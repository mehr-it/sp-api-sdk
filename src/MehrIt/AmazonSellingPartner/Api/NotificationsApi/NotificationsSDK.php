...
namespace MehrIt\AmazonSellingPartner\Api\NotificationsApi;
...
final class NotificationsSDK
{
     ...
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\Notifications\CreateDestinationRequest $body body (required)
     *
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\Notifications\CreateDestinationRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
