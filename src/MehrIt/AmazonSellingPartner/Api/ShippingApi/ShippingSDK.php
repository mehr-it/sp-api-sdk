...
namespace MehrIt\AmazonSellingPartner\Api\ShippingApi;
...
final class ShippingSDK
{
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\CreateShipmentRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\CreateShipmentRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\GetRatesRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\GetRatesRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
     ...
     * @param string $region
     * @param string $shipment_id shipment_id (required)
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\PurchaseLabelsRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     ...
     * @param string $region
     * @param string $shipment_id (required)
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\PurchaseLabelsRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\PurchaseShipmentRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\PurchaseShipmentRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
     ...
     * @param string $shipment_id shipment_id (required)
     * @param string $tracking_id tracking_id (required)
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\RetrieveShippingLabelRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     ...
     * @param string $shipment_id (required)
     * @param string $tracking_id (required)
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\RetrieveShippingLabelRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
