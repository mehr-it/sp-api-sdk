...
namespace MehrIt\AmazonSellingPartner\Api\VendorOrdersApi;
...
final class VendorDirectFulfillmentOrdersSDK
{
    ...
    public function getOrder(AccessToken $accessToken, string $region, $purchase_order_number)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentOrders\GetOrderResponse::class,
            []
        );
    }
    ...
    public function getOrders(AccessToken $accessToken, string $region, $created_after, $created_before, $ship_from_party_id = null, $status = null, $limit = null, $sort_order = null, $next_token = null, $include_details = 'true')
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentOrders\GetOrdersResponse::class,
            []
        );
    }
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentOrders\SubmitAcknowledgementRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
    ...
    public function submitAcknowledgement(AccessToken $accessToken, string $region, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            \MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentOrders\SubmitAcknowledgementResponse::class,
            []
        );
    }
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentOrders\SubmitAcknowledgementRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
