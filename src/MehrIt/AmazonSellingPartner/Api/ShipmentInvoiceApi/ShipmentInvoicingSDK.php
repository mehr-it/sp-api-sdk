...
namespace MehrIt\AmazonSellingPartner\Api\ShipmentInvoiceApi;
...
final class ShipmentInvoicingSDK
{
     ...
     * @param \MehrIt\AmazonSellingPartner\Model\ShipmentInvoicing\SubmitInvoiceRequest $body body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\ApiException on non-2xx response
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     ...
     * @param string $region
     * @param string $shipment_id The identifier for the shipment. (required)
     * @param \MehrIt\AmazonSellingPartner\Model\ShipmentInvoicing\SubmitInvoiceRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
     * @return RequestInterface
     */
