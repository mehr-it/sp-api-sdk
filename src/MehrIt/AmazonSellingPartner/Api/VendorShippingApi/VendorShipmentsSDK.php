...
final class VendorShipmentsSDK
{
     ...
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\VendorShipments\SubmitShipmentConfirmationsRequest $body body (required)
     *
     ...
     * @param AccessToken $accessToken
     * @param string $region
     * @param \MehrIt\AmazonSellingPartner\Model\VendorShipments\SubmitShipmentConfirmationsRequest $body (required)
     *
     * @throws \MehrIt\AmazonSellingPartner\Exception\InvalidArgumentException
