...
final class VendorDirectFulfillmentShippingSDK
{
    ...
    public function getPackingSlip(AccessToken $accessToken, string $region, $purchase_order_number)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentShipping\GetPackingSlipResponse',
            []
        );
    }
    ...
    public function getPackingSlips(AccessToken $accessToken, string $region, $created_after, $created_before, $ship_from_party_id = null, $limit = null, $sort_order = 'ASC', $next_token = null)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentShipping\GetPackingSlipListResponse',
            []
        );
    }
    ...
    public function submitShipmentConfirmations(AccessToken $accessToken, string $region, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentShipping\SubmitShipmentConfirmationsResponse',
            []
        );
    }
    ...
    public function submitShipmentStatusUpdates(AccessToken $accessToken, string $region, $body)
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\MehrIt\AmazonSellingPartner\Model\VendorDirectFulfillmentShipping\SubmitShipmentStatusUpdatesResponse',
            []
        );
    }
