...
class ListingsItemPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'product_type' => 'string',
        'patches' => '\MehrIt\AmazonSellingPartner\Model\ListingsItems\PatchOperation[]'
    ];
     ...
     * Gets patches
     *
     * @return \MehrIt\AmazonSellingPartner\Model\ListingsItems\PatchOperation[]
     */
     ...
     * Sets patches
     *
     * @param \MehrIt\AmazonSellingPartner\Model\ListingsItems\PatchOperation[] $patches One or more JSON Patch operations to perform on the listings item.
     *
     * @return self
     */
