...
class UpdateScheduleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'schedules' => '\MehrIt\AmazonSellingPartner\Model\Services\AvailabilityRecord[]'
    ];
     ...
     * Sets schedules
     *
     * @param \MehrIt\AmazonSellingPartner\Model\Services\AvailabilityRecord[] $schedules List of `AvailabilityRecord`s to represent the capacity of a resource over a time range.
     *
     * @return self
     */
