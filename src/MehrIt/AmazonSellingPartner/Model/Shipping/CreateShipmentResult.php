...
class CreateShipmentResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'shipment_id' => 'string',
        'eligible_rates' => '\MehrIt\AmazonSellingPartner\Model\Shipping\Rate[]'
    ];
     ...
     * Gets eligible_rates
     *
     * @return \MehrIt\AmazonSellingPartner\Model\Shipping\Rate[]
     */
     ...
     * Sets eligible_rates
     *
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\Rate[] $eligible_rates A list of all the available rates that can be used to send the shipment.
     *
     * @return self
     */
