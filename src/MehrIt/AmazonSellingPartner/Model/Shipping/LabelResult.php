...
class LabelResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'tracking_id' => 'string',
        'label' => '\MehrIt\AmazonSellingPartner\Model\Shipping\Label'
    ];
     ...
     * Gets label
     *
     * @return \MehrIt\AmazonSellingPartner\Model\Shipping\Label|null
     */
     ...
     * Sets label
     *
     * @param \MehrIt\AmazonSellingPartner\Model\Shipping\Label|null $label label
     *
     * @return self
     */
