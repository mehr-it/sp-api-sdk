<?php
/**
 * InventorySnapshotMarketplaceAttributes
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 */
class InventorySnapshotMarketplaceAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InventorySnapshot_marketplaceAttributes';
     ...
     * Sets channel_name
     *
     * @param string|null $channel_name The name of the channel within the marketplace (if applicable).
     *
     * @return self
     */
