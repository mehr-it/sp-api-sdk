 ...
 */
class PackagePackageLineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Package_packageLineItem';
     ...
     * Sets id
     *
     * @param string $id The identifier of the shipment's line item that is packaged into a package.
     *
     * @return self
     */
