 ...
 */
class ShipmentMetadataAdapterApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Shipment_metadata_adapterApp';
     ...
     * Sets id
     *
     * @param string $id The unique id of the adapter
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The unique name of the adapter
     *
     * @return self
     */
