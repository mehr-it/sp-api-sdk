...
class Packages implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets packages
     *
     * @return \MehrIt\AmazonSellingPartner\Model\ExternalFulfillmentShipments\Package[]
     */
     ...
     * Sets packages
     *
     * @param \MehrIt\AmazonSellingPartner\Model\ExternalFulfillmentShipments\Package[] $packages An array containing the description of the packages for shipment fulfillment.
     *
     * @return self
     */
