...
class Tax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'type' => 'string',
        'rate' => 'string',
        'charge' => '\MehrIt\AmazonSellingPartner\Model\ExternalFulfillmentShipments\ChargeBreakup'
    ];
     ...
     * Sets type
     *
     * @param string|null $type type of tax
     *
     * @return self
     */
     ...
     * Sets rate
     *
     * @param string|null $rate A decimal number with no loss of precision. Useful when precision loss is unacceptable, as with currencies. Follows RFC7159 for number representation.
     *
     * @return self
     */
     ...
     * Gets charge
     *
     * @return \MehrIt\AmazonSellingPartner\Model\ExternalFulfillmentShipments\ChargeBreakup
     */
     ...
     * Sets charge
     *
     * @param \MehrIt\AmazonSellingPartner\Model\ExternalFulfillmentShipments\ChargeBreakup $charge charge
     *
     * @return self
     */
