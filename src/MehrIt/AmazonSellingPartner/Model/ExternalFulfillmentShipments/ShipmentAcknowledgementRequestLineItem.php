<?php
/**
 * ShipmentAcknowledgementRequestLineItem
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 */
class ShipmentAcknowledgementRequestLineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ShipmentAcknowledgementRequest_lineItem';
     ...
     * Sets id
     *
     * @param string $id The identifier of the line item from the shipment which is being confirmed/rejected by the seller.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity no of line item
     *
     * @return self
     */
