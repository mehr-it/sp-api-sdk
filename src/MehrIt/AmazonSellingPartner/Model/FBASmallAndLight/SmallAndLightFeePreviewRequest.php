...
class SmallAndLightFeePreviewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'items' => '\MehrIt\AmazonSellingPartner\Model\FBASmallAndLight\Item[]'
    ];
     ...
     * Gets items
     *
     * @return \MehrIt\AmazonSellingPartner\Model\FBASmallAndLight\Item[]
     */
     ...
     * Sets items
     *
     * @param \MehrIt\AmazonSellingPartner\Model\FBASmallAndLight\Item[] $items A list of items for which to retrieve fee estimates (limit: 25).
     *
     * @return self
     */
